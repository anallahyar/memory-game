...
import shuffle from "shuffle-array"    // var shuffle = require('shuffle-array')
import uuidv4 from "uuid/v4"           // const uuidv4 = require('uuid/v4');
...
// this is a function given by extending our React class

   resetButton = () => {
     this.setState ({ cards: this.setupGame()})
   }

//  When we change properties of components, we set the state for them to take effect
...
//tells us what can we get, defines the default export
// use curly brackets to run JavaScript within the React component
